var citySelectObject = {
    ...
    showDrag:document.getElementsByClassName('dragDown')[0],
    ...
    cityClick:function(e){
        ...
        this.showDrag.style.display = 'none';
    ...
    showProvince:function(){
        ...
        this.fontStr.onclick  = function(){
            if(self.bool){
                self.bool =  false;
                self.showDrag.style.display = 'block';
                self.ishow.style.backgroundPosition = '0 '+'-2067px';
            }else{
                self.bool =  true;
                self.showDrag.style.display = 'none';
...
citySelectObject.init()
// console.log(citySelectObject.province);
// console.log(citySelectObject.city)